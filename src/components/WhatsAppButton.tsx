  ...
  return (
    ...
    >
      <div className="relative">
        {/* Pulse Effect */}
        <div className="absolute top-0 left-0 w-full h-full bg-green-500 rounded-full animate-ping opacity-75"></div>
        
        {/* SVG Icon */}
        <div className="relative bg-transparent rounded-full overflow-hidden shadow-2xl">
          <svg 
